...
import user2Img from '@/assets/images/user1.png';
import user3Img from '@/assets/images/user.png';
...
const MessageContainer = () => {
  return (
    <div className="lg:mx-auto ">
      <div className="relative z-10 flex flex-col rounded-xl rounded-t-xl border-t-8 border-t-main-color  px-10 py-8 lg:flex-row">
        {/* left */}
