                ...
                {cards.map((card, index) => (
                    ...
                    >
                        <CardContent className="p-6 text-center">
                            ...
                            <AspectRatio ratio={16 / 9} className="relative rounded-xl overflow-hidden mb-2">
                                <Image
                                    src={card.image}
                                    alt={card.title}
                                    fill
                                ...
                                />
                                <Link href={card.href} className="absolute inset-0 flex items-center justify-center group">
