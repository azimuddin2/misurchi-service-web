    ...
    return (
        <Card className="overflow-hidden transition-all hover:shadow-lg hover:scale-[1.01] rounded-xl p-0">
            ...
            <CardContent className="pt-12 pb-4 text-center space-y-3">
                {/* Name + Rating */}
                <div>
                    <h4 className="font-semibold text-lg text-gray-800">{vendor.businessName}</h4>
                ...
                <p className="text-sm text-gray-600 line-clamp-3">
                    Fashion lover 💫 | Curating the best of chic and street style ✨ | 10% of my
                    sales go to supporting youth education 📚 | Join me on this stylish journey!
                </p>
                ...
                <AppButton
                    ...
                    content={
                        ...
                        >
                            <span className="uppercase text-sm font-semibold me-3">View Profile</span>
                            <ArrowRight size={24} />
                        </Link>
                    }
                />
